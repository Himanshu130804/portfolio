// This fallback keeps the already-deployed frontend useful even if the backend
// is temporarily unavailable. Once your API is connected, database content wins.
export const fallbackPortfolio = {
  hero: {
    ...
    description:
      "Director of Sports & Physical Education with a career spanning elite competition, university sports leadership and athlete development.",
    image: "/images/25.jpg",
